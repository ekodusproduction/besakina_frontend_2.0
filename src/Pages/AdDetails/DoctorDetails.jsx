...
const DoctorDetails = () => {
    ...
    useEffect(()=> {
        axiosInstance.get(`api/doctors/id/${id}`)
        .then(response => {
        ...
        <div className='md:px-12 sm:px-4 px-2 py-8'>
            ...
            <section className='xl:w-3/5 border-[1px] border-slate-400 sm:mt-8 mt-4 p-4 rounded-md overflow-x-scroll'>
                ...
                <div className='flex flex-col gap-2 min-w-[600px]'>
                    ...
                    <div className='flex justify-between'>
                        <p className='w-1/4 text-sm text-slate-500'>Total Experience</p>
                        <p className='w-1/4 text-sm text-slate-700'>{educationData?.total_experience} years</p>
