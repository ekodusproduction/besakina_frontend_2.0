          ...
          <div className='bg-white shadow rounded lg:w-[300px] h-fit'>
            ...
            <div className='py-2 px-4 hidden lg:block'>
                <div className='flex gap-2 items-center py-2 my-[3px] rounded'>
                    <div><CiUser color='gray'/></div>
                    <button onClick={()=>setSelectedMenu('addprofile')} className='text-gray-700'>Profile</button>
                </div>
                <div className='flex gap-2 items-center py-2 my-[3px] rounded'>
                    <div><CiBookmark color='gray'/></div>
                    <button onClick={()=>setSelectedMenu('mylisting')} className='text-gray-700'>My Listing</button>
                </div>
                <div className='flex gap-2 items-center py-2 my-[3px] rounded'>
                    <div><IoBagAddOutline color='gray'/></div>
                    <Link to='/postad' className='text-gray-700'>Add Listing</Link>
                </div>
                <div className='flex gap-2 items-center py-2 my-[3px] rounded'>
                    <div><CiTrash color='gray'/></div>
                    <button onClick={()=>setSelectedMenu('deleteprofile')} className='text-gray-700'>Delete profile</button>
                </div>
            </div>
            {showMenu && 
